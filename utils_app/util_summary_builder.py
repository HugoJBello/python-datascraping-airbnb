...
class UtilsSummaryBuilder:
    ...
    def __init__(self, data, scrapped_url, scrapped_prize, date_from, date_to):
        self.data = data
    ...
    def obtain_summary(self):
        ...
        self.summary=SummaryScrappedDTO(self.scrapped_prize,self.number_of_items,self.scrapped_url,self.mean_prize_m2, self.date_from, self.date_to)
